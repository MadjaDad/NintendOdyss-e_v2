...
const DATA = {
  consoles: {
    gba: {
      ...
      ready: true,
      games: [
        {slug:"castlevania-circle-of-the-moon", title:"Castlevania: Circle of the Moon", date:"2001-06-11", score:82, scoreType:"user", hltb:"8h", blurb:"Premier Castlevania a adopter la formule Metroidvania sur portable, sombre et exigeant."},
        ...
        {slug:"advance-wars", title:"Advance Wars", date:"2001-09-10", score:82, scoreType:"user", hltb:"14h", blurb:"Le classique tour par tour d'Intelligent Systems, equilibre et accessible."},
        ...
        {slug:"castlevania-harmony-of-dissonance", title:"Castlevania: Harmony of Dissonance", date:"2002-09-16", score:80, scoreType:"user", hltb:"8h", blurb:"Juste Belmont dans un épisode plus lumineux, signé Koji Igarashi."},
        ...
        {slug:"pokemon-ruby-sapphire", title:"Pokémon Ruby & Sapphire", date:"2003-03-19", score:80, scoreType:"user", hltb:"30h", blurb:"Troisième génération à Hoenn, combats en double et natures."},
        ...
        {slug:"castlevania-aria-of-sorrow", title:"Castlevania: Aria of Sorrow", date:"2003-05-06", score:83, scoreType:"user", hltb:"8h", blurb:"Système d'âmes d'une richesse folle, sommet de la trilogie GBA."},
        ...
        {slug:"advance-wars-2", title:"Advance Wars 2: Black Hole Rising", date:"2003-06-23", score:80, scoreType:"user", hltb:"15h", blurb:"Suite mieux équilibrée, nouvelle campagne et généraux retouchés."},
        ...
        {slug:"harvest-moon-fomt", title:"Harvest Moon: Friends of Mineral Town", date:"2003-11-17", score:78, scoreType:"user", hltb:"50h", blurb:"La vie de ferme portable par excellence, au fil des saisons."},
        {slug:"mario-and-luigi-superstar-saga", title:"Mario & Luigi: Superstar Saga", date:"2003-11-17", score:85, scoreType:"user", hltb:"15h", blurb:"RPG en duo hilarant, combos et timing au coeur des combats."},
        ...
        {slug:"mario-vs-donkey-kong", title:"Mario vs. Donkey Kong", date:"2004-05-24", score:76, scoreType:"user", hltb:"5h", blurb:"Casse-tête de plateforme héritier du Donkey Kong Game Boy."},
        ...
        {slug:"mega-man-zero-3", title:"Mega Man Zero 3", date:"2004-10-05", score:75, scoreType:"user", hltb:"4h", blurb:"Troisième volet, la formule affinée sans rien casser."},
        ...
        {slug:"final-fantasy-1-2-dawn-of-souls", title:"Final Fantasy I & II: Dawn of Souls", date:"2004-11-29", score:77, scoreType:"user", hltb:"16h", blurb:"Les deux premiers Final Fantasy rajeunis, donjons bonus inclus."},
        ...
        {slug:"harvest-moon-more-fomt", title:"Harvest Moon: More Friends of Mineral Town", date:"2005-07-19", score:75, scoreType:"user", hltb:"50h", blurb:"Même ferme vue par une héroïne, avec davantage de prétendants."},
        ...
        {slug:"final-fantasy-4-advance", title:"Final Fantasy IV Advance", date:"2005-12-12", score:78, scoreType:"user", hltb:"20h", blurb:"Le drame de Cecil enrichi de donjons et d'options d'équipe inédites."},
        ...
        {slug:"pokemon-mystery-dungeon-red", title:"Pokémon Mystery Dungeon: Red Rescue Team", date:"2006-09-18", score:77, scoreType:"user", hltb:"20h", blurb:"Donjons générés et Pokémon jouables, pont entre GBA et DS."},
        {slug:"final-fantasy-5-advance", title:"Final Fantasy V Advance", date:"2006-11-06", score:78, scoreType:"user", hltb:"25h", blurb:"Le système de jobs le plus libre de la série, dans sa meilleure version."},
        {slug:"final-fantasy-6-advance", title:"Final Fantasy VI Advance", date:"2007-02-05", score:86, scoreType:"user", hltb:"28h", blurb:"Le sommet 16 bits de Square, augmenté de donjons et d'invocations."}
      ]
    },
    ...
    ds: {
      ...
      games: [
        ...
        {slug:"castlevania-dawn-of-sorrow", title:"Castlevania: Dawn of Sorrow", date:"2005-10-04", score:83, scoreType:"user", hltb:"9h", blurb:"Suite directe d'Aria of Sorrow, visuels et système d'âmes sublimés."},
        ...
        {slug:"phoenix-wright-ace-attorney", title:"Phoenix Wright: Ace Attorney", date:"2005-10-11", score:84, scoreType:"user", hltb:"15h", blurb:"Premiers procès d'un avocat devenu légende, écriture irrésistible."},
        ...
        {slug:"castlevania-portrait-of-ruin", title:"Castlevania: Portrait of Ruin", date:"2006-12-05", score:82, scoreType:"user", hltb:"9h", blurb:"Duo jouable explorant des tableaux maudits, suite de Bloodlines."},
        ...
        {slug:"pokemon-diamond-pearl", title:"Pokémon Diamond & Pearl", date:"2007-04-22", score:79, scoreType:"user", hltb:"40h", blurb:"Quatrième génération à Sinnoh, premiers échanges Wi-Fi mondiaux."},
        ...
        {slug:"phoenix-wright-trials-and-tribulations", title:"Phoenix Wright: Trials and Tribulations", date:"2007-10-23", score:86, scoreType:"user", hltb:"18h", blurb:"Conclusion magistrale de la trilogie originale."},
        ...
        {slug:"apollo-justice", title:"Apollo Justice: Ace Attorney", date:"2008-02-19", score:80, scoreType:"user", hltb:"16h", blurb:"Nouvelle génération au barreau, sept ans après Phoenix."},
        ...
        {slug:"the-world-ends-with-you", title:"The World Ends With You", date:"2008-04-22", score:81, scoreType:"user", hltb:"20h", blurb:"RPG ultra-stylé dans Shibuya, combats répartis sur les deux écrans."},
        ...
        {slug:"final-fantasy-4-ds", title:"Final Fantasy IV", date:"2008-07-22", score:80, scoreType:"user", hltb:"25h", blurb:"Remake 3D exigeant du drame de Cecil, avec système d'augmentations."},
        ...
        {slug:"castlevania-order-of-ecclesia", title:"Castlevania: Order of Ecclesia", date:"2008-10-21", score:83, scoreType:"user", hltb:"10h", blurb:"Shanoa et ses glyphes, le plus exigeant des Castlevania DS."},
        {slug:"chrono-trigger-ds", title:"Chrono Trigger", date:"2008-11-25", score:89, scoreType:"user", hltb:"23h", blurb:"Le voyage temporel légendaire, dans sa version la plus complète."},
        ...
        {slug:"rhythm-heaven", title:"Rhythm Heaven", date:"2009-04-05", score:79, scoreType:"user", hltb:"8h", blurb:"Mini-jeux de rythme absurdes signés par l'équipe de WarioWare."},
        {slug:"smt-devil-survivor", title:"Shin Megami Tensei: Devil Survivor", date:"2009-06-23", score:82, scoreType:"user", hltb:"30h", blurb:"Tokyo bouclé sept jours, tactique et enchères de démons."},
        ...
        {slug:"mario-and-luigi-bowsers-inside-story", title:"Mario & Luigi: Bowser's Inside Story", date:"2009-09-14", score:84, scoreType:"user", hltb:"25h", blurb:"Bowser jouable et son intérieur explorable, sommet de la série."},
        ...
        {slug:"smt-strange-journey", title:"Shin Megami Tensei: Strange Journey", date:"2010-03-23", score:81, scoreType:"user", hltb:"40h", blurb:"Expédition antarctique austère, l'un des MegaTen les plus aimés."},
        ...
        {slug:"999", title:"999: Nine Hours, Nine Persons, Nine Doors", date:"2010-11-16", score:82, scoreType:"user", hltb:"10h", blurb:"Visual novel et escape game, neuf inconnus piégés sur un navire."},
        ...
        {slug:"ghost-trick", title:"Ghost Trick: Phantom Detective", date:"2011-01-11", score:80, scoreType:"user", hltb:"12h", blurb:"Sitôt mort, Sissel manipule les objets pour changer le destin des vivants."},
        ...
        {slug:"radiant-historia", title:"Radiant Historia", date:"2011-02-22", score:79, scoreType:"user", hltb:"30h", blurb:"RPG à voyages temporels entre deux lignes d'histoire parallèles."},
        ...
        {slug:"smt-devil-survivor-2", title:"Shin Megami Tensei: Devil Survivor 2", date:"2012-02-28", score:80, scoreType:"user", hltb:"40h", blurb:"Les Septentriones attaquent le Japon, tactique et choix moraux."},
    ...
    n3ds: {
      ...
      games: [
        ...
        {slug:"resident-evil-revelations", title:"Resident Evil Revelations", date:"2012-02-07", score:79, scoreType:"user", hltb:"9h", blurb:"Survival horror en huis clos maritime, prouesse technique sur portable."},
        ...
        {slug:"luigis-mansion-dark-moon", title:"Luigi's Mansion: Dark Moon", date:"2013-03-24", score:81, scoreType:"user", hltb:"12h", blurb:"Luigi reprend l'aspirateur à fantômes, la 3D en fait un diorama."},
        ...
        {slug:"donkey-kong-country-returns-3d", title:"Donkey Kong Country Returns 3D", date:"2013-05-24", score:80, scoreType:"user", hltb:"8h", blurb:"Le retour exigeant des Kong, augmenté d'un monde inédit."},
        ...
        {slug:"phoenix-wright-dual-destinies", title:"Phoenix Wright: Ace Attorney - Dual Destinies", date:"2013-10-24", score:79, scoreType:"user", hltb:"20h", blurb:"Phoenix reprend le barreau dans une ère sombre du droit."},
        ...
        {slug:"shovel-knight", title:"Shovel Knight", date:"2014-06-26", score:83, scoreType:"user", hltb:"6h", blurb:"Hommage parfait aux plateformers NES, à la pelle et au StreetPass."},
        ...
        {slug:"theatrhythm-curtain-call", title:"Theatrhythm Final Fantasy: Curtain Call", date:"2014-09-16", score:79, scoreType:"user", hltb:"15h", blurb:"Toute la musique de Final Fantasy en jeu de rythme encyclopédique."},
        ...
        {slug:"shantae-pirates-curse", title:"Shantae And The Pirate's Curse", date:"2014-10-23", score:79, scoreType:"user", hltb:"9h", blurb:"Aventure 2D de WayForward, humour et level design ciselé."},
        ...
        {slug:"phoenix-wright-trilogy-3ds", title:"Phoenix Wright: Ace Attorney Trilogy", date:"2014-12-11", score:80, scoreType:"user", hltb:"45h", blurb:"Les trois premiers procès réunis, valeur imbattable."},
        ...
        {slug:"xenoblade-chronicles-3d", title:"Xenoblade Chronicles 3D", date:"2015-04-10", score:82, scoreType:"user", hltb:"60h", blurb:"L'immense RPG de Monolith Soft tenu dans une portable, sur New 3DS."},
        ...
        {slug:"steamworld-heist", title:"SteamWorld Heist", date:"2015-12-10", score:79, scoreType:"user", hltb:"15h", blurb:"Tactique au tour par tour où chaque tir se vise à la main."},
        ...
        {slug:"phoenix-wright-spirit-of-justice", title:"Phoenix Wright: Ace Attorney - Spirit of Justice", date:"2016-09-08", score:79, scoreType:"user", hltb:"25h", blurb:"Procès dans un royaume où l'on juge par les visions des morts."},
        ...
        {slug:"pokemon-sun-moon", title:"Pokémon Sun and Moon", date:"2016-11-18", score:79, scoreType:"user", hltb:"35h", blurb:"Direction Alola, épreuves insulaires à la place des arènes."},
    ...
    gamecube: {
      ...
      ready: true,
      games: [
        {slug:"super-monkey-ball", title:"Super Monkey Ball", date:"2001-11-18", score:81, scoreType:"user", hltb:"5h", blurb:"Sega ouvre le bal sur console Nintendo, concept simple et redoutable."},
        {slug:"luigis-mansion", title:"Luigi's Mansion", date:"2001-11-18", score:84, scoreType:"user", hltb:"6h", blurb:"Luigi aspire les fantômes d'un manoir, parodie de genre pleine de charme."},
        ...
        {slug:"pikmin", title:"Pikmin", date:"2001-12-02", score:83, scoreType:"user", hltb:"10h", blurb:"Miyamoto invente sa stratégie en temps réel, trente jours pour repartir."},
        ...
        {slug:"sonic-adventure-2-battle", title:"Sonic Adventure 2: Battle", date:"2002-02-11", score:79, scoreType:"user", hltb:"11h", blurb:"Version enrichie de l'aventure Dreamcast, Chao Garden inclus."},
        {slug:"resident-evil-remake", title:"Resident Evil", date:"2002-04-30", score:82, scoreType:"user", hltb:"11h", blurb:"Remake somptueux du survival horror fondateur, décors repeints à la main."},
        ...
        {slug:"super-mario-sunshine", title:"Super Mario Sunshine", date:"2002-08-26", score:81, scoreType:"user", hltb:"16h", blurb:"Mario et sa pompe J.E.T. nettoient l'île Delfino, vacances ensoleillées."},
        {slug:"super-monkey-ball-2", title:"Super Monkey Ball 2", date:"2002-08-27", score:81, scoreType:"user", hltb:"9h", blurb:"Suite dotée d'un mode histoire et de mini-jeux multijoueur mémorables."},
        ...
        {slug:"metroid-prime", title:"Metroid Prime", date:"2002-11-18", score:91, scoreType:"user", hltb:"14h", blurb:"Passage magistral à la première personne, immersion totale sur Tallon IV."},
        ...
        {slug:"resident-evil-2-gc", title:"Resident Evil 2", date:"2003-01-16", score:79, scoreType:"user", hltb:"11h", blurb:"Portage fidèle du classique PlayStation, sans fioritures mais toujours grand."},
        ...
        {slug:"zelda-ocarina-master-quest", title:"The Legend of Zelda: Ocarina of Time / Master Quest", date:"2003-02-17", score:86, scoreType:"user", hltb:"26h", blurb:"Ocarina of Time accompagné de sa version aux donjons remixés."},
        {slug:"zelda-wind-waker", title:"The Legend of Zelda: The Wind Waker", date:"2003-03-24", score:91, scoreType:"user", hltb:"26h", blurb:"Navigation en cel-shading intemporel sur un océan sans fin."},
        ...
        {slug:"soulcalibur-2", title:"SoulCalibur II", date:"2003-08-27", score:83, scoreType:"user", hltb:"6h", blurb:"Combat à l'arme blanche au sommet, avec Link en invité exclusif."},
        ...
        {slug:"beyond-good-and-evil", title:"Beyond Good & Evil", date:"2003-11-11", score:82, scoreType:"user", hltb:"10h", blurb:"Jade enquête sur Hillys, aventure culte de Michel Ancel."},
        ...
        {slug:"prince-of-persia-sands-of-time", title:"Prince of Persia: The Sands of Time", date:"2003-11-18", score:83, scoreType:"user", hltb:"8h", blurb:"Renaissance acrobatique de la série, avec la dague qui remonte le temps."},
        {slug:"xiii", title:"XIII", date:"2003-11-24", score:79, scoreType:"user", hltb:"10h", blurb:"FPS en cel-shading adapté de la bande dessinée, style avant tout."},
        ...
        {slug:"tales-of-symphonia", title:"Tales of Symphonia", date:"2004-07-13", score:82, scoreType:"user", hltb:"45h", blurb:"Action-RPG généreux de Namco, premier de la série en 3D."},
        {slug:"pikmin-2", title:"Pikmin 2", date:"2004-08-30", score:84, scoreType:"user", hltb:"20h", blurb:"Suite sans limite de temps, grottes, trésors et deux capitaines."},
        {slug:"paper-mario-thousand-year-door", title:"Paper Mario: The Thousand-Year Door", date:"2004-10-11", score:91, scoreType:"user", hltb:"35h", blurb:"RPG en papier à l'écriture hilarante, sommet de la branche."},
        ...
        {slug:"baten-kaitos", title:"Baten Kaitos: Eternal Wings and the Lost Ocean", date:"2004-11-16", score:84, scoreType:"user", hltb:"55h", blurb:"RPG à cartes aux décors peints, dans un monde d'îles célestes."},
        ...
        {slug:"resident-evil-4", title:"Resident Evil 4", date:"2005-01-11", score:89, scoreType:"user", hltb:"16h", blurb:"Révolution du TPS à la caméra à l'épaule, chef-d'oeuvre de Capcom."},
        ...
        {slug:"killer7", title:"Killer7", date:"2005-07-07", score:79, scoreType:"user", hltb:"15h", blurb:"Thriller radical de Suda51, sept tueurs dans un même corps."},
        ...
        {slug:"prince-of-persia-two-thrones", title:"Prince of Persia: The Two Thrones", date:"2005-12-01", score:79, scoreType:"user", hltb:"8h", blurb:"Conclusion de la trilogie, équilibre parfait entre combat et plateforme."},
        {slug:"lego-star-wars-2", title:"LEGO Star Wars II: The Original Trilogy", date:"2006-09-12", score:79, scoreType:"user", hltb:"10h", blurb:"La trilogie originale en briques, humour et coopération."},
        {slug:"baten-kaitos-origins", title:"Baten Kaitos Origins", date:"2006-09-25", score:80, scoreType:"user", hltb:"40h", blurb:"Préquelle au système de cartes affiné, sortie en toute fin de vie."},
        {slug:"zelda-twilight-princess", title:"The Legend of Zelda: Twilight Princess", date:"2006-12-11", score:88, scoreType:"user", hltb:"34h", blurb:"Link loup et crépuscule, ultime grand jeu de la console."}
      ]
    },
